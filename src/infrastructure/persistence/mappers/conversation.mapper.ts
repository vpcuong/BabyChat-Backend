import { ConversationEntity, ConversationSettings, PageRef } from 'src/domain/conversation/entities/conversation.entity';
import { ParticipantEntity, ParticipantRole } from 'src/domain/conversation/entities/participant.entity';
